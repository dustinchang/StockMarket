...
"""
## Process trading an investment between two investors
#
#
def trade(user1, user2, inv_index):
    # load user profiles
    user1 = pickle.load(open("./SMfiles/users/{}".format(user1), "rb"))
    user2 = pickle.load(open("./SMfiles/users/{}".format(user2), "rb"))
